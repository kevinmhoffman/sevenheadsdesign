...
<body class="about" style="">
	<div class="page" id="page">
		...
		<p class="intro" style="text-align: center;"><strong>Thank You for Five Fantastic Years</strong></p>
		<p class="beta beta--wider beta--smaller-at-narrow" style="text-align: center;">
		...
		<section class="nodes-section">
			...
			<ul class="nodes nodes--3-4-rows">
				...
				<li>
					...
					<svg class="narrow-only">
						<line x1="0" y1="100%" x2="100%" y2="0" style="stroke:#C9332B;stroke-width:4.5"/>
					</svg>
				</li>
				<li>
					<div class="block">
